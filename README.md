...
Token's are used for authentication purposes.
2. What steps can you take in your web apps to keep your data secure?
Having tokens as well as private routes.
3. Describe how web servers work.
web servers are like stand alone computers that run our websites. it helps distribute our web pages data and informatiom.
